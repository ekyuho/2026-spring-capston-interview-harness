...
- 기말에는 사용자가 영어 문장을 입력하면 시스템이 이를 5개 축(Formality, Energy, Intimacy, Humor, Curiosity)으로 분석하고, 그 결과를 CHARACTER MATRIX에 반영하여 AI 캐릭터의 반응 성향과 시각적 상태가 달라지는 웹 기반 프로토타입을 보여줄 계획입니다.
