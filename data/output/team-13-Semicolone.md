...
- **본인의 기술적 관심영역,  실제로 만들어서 작동시켜본 산출물, 남보다 잘한다고 생각되는 영역 등 소개**: 프론트 엔드 웹개발 쪽에 대해 가장 관심이 큽니다.. 다른사람들보다 좀더 성실하고 모르는 부분들도 빠르게 공부해나가는 부분이 저의 가장 큰 장점이라고 생각합니다.
- **이번에 팀이 구성된 계기**: 에브리타임을 통해 같이 성실하게 열심히 하실분들을 구하게 되었습니다. 프로젝트 경험은 거의없지만 공부해서 성실하게 하는 것이 가장 중요하다 생각해 최선을 다하겠습니다.

### 윤현진

- **본인의 기술적 관심영역,  실제로 만들어서 작동시켜본 산출물, 남보다 잘한다고 생각되는 영역 등 소개**: 관심 영역: 차량 네트워크에서 V2V offloading 관련 영역
...
- **질문당 한줄씩 5개의 질문**: 1.gpt로 공부/과제할 때, 나중에 다시 찾으려고 저장해둔 적이 있나요?
...
- **질문당 한줄씩 5개의 질문**: 1. 평소 ChatGPT 같은 AI를 얼마나 자주 사용하시고, 주로 어떤 상황에서 사용하시나요?
...
- **질문당 한줄씩 5개의 질문**: - AI를 얼마나 자주 이용하나요?
- AI를 어떤 목적으로 사용하나요?
